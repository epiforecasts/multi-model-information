...
```{r width-ensembles, fig.width = 12}
...
ensemble_plot |>
    ...
    geom_vline(xintercept = min(forecast_dates),
               lty = 2) +
    # ----- Structure
    # facets
  ...
  ggsave("output/figure-3.jpg", height = 8, width = 8)
```
